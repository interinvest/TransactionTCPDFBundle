<?php
namespace InterInvest\TransactionTCPDFBundle;

use Symfony\Component\HttpKernel\Bundle\Bundle;
use Symfony\Component\Filesystem\Filesystem;

class TransactionTCPDFBundle extends Bundle
{
    /**
    ...
    {
        if (!$this->container->hasParameter('transaction_tcpdf')) {
            return;
        }
        // Define our TCPDF variables
        $config = $this->container->getParameter('transaction_tcpdf');
